...
export class PageActionsFields {
   ...
   */
  async modify_name(this: PageData, rpc: any): Promise<void> {
   ...
   */
  async modify_text(this: PageData, rpc: any): Promise<void> {
    const pageId = this.id;
    if (!pageId) {
      alert('No page ID found');
      return;
   ...
   */
  async combo(this: PageData, rpc: any): Promise<void> {
    const pageId = this.id;
    if (!pageId) {
      alert('No page ID found');
      return;
