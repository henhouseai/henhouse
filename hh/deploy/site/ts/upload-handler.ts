  ...
  async handle(): Promise<void> {
    ...
    this.overlay = overlayManager.show({
      ...
      onMount: () => {
        ...
        const placeholderContentDiv = document.querySelector('#overlayWindow .content.overlay:has(.upload-placeholder)') as HTMLElement;
      ...
      setTimeout(() => {
        const headerEl = document.querySelector('#overlayWindow .contentWrapperHeader.overlay') as HTMLElement;
        if (!headerEl) {
