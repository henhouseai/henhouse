...
export class OverlayDebugTable {
     ...
     */
    getFilenameColorIndex(module, filename) {
     ...
     */
    getFunctionColorIndex(module, filename, functionName) {
