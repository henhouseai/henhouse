...
def create_user_gateway_scripts(project_name: str) -> None:
...
def create_user_hen_scripts(project_name: str) -> None:
...
def create_root_gateway_script(project_name: str, project_path: Path) -> None:
...
def setup_user_convenience_scripts(project_name: str, project_path: Path, username: str, is_root: bool = False) -> None:
...
def setup_human_user_home(project_name: str, project_path: Path) -> None:
    ...
    try:
        ...
        setup_user_convenience_scripts(project_name, project_path, project_owner, is_root=False)
...
def setup_root_user_script(project_name: str, project_path: Path) -> None:
