...
def maintenance_jobs_status_action() -> bool:
    ...
    try:
        ...
        log(f"Maintenance status: pages={stale_pages}, images={stale_images}, files={stale_files}, jobs={pending_jobs}, errors={error_jobs}")
        trace_out()
        return True
    ...
    try:
        ...
        lines.append(
            render_block(
                ...
                .add_simple(["stale_pages_count", "stale_images_count", "stale_files_count", "pending_job"])
