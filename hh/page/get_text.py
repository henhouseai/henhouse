...
def get_text() -> bool:
    ...
    if not is_error():
        ...
        # Process text through TextProcessor with HTTP final_decorator
        # This gives us the same output format as HTTP backend rendering
        processor = TextProcessor(final_decorator='http')
