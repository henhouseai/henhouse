...
@register_parser('copy_audio')
@register_parser('copy_audios')
@register_parser('move_audio')
@register_parser('move_audios')
@register_parser('remove_audio')
@register_parser('copy_video')
@register_parser('copy_videos')
@register_parser('move_video')
@register_parser('move_videos')
@register_parser('remove_video')
@register_parser('copy_file')
@register_parser('move_file')
@register_parser('add_file')
@register_parser('add_files')
def show_page() -> bool:
    trace_in()
    gateway = get_gateway()
