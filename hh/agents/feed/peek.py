...
from hh.gateway.connection.connection import r_query, iso_now, ensure_iso_timestamps
...
@db_read
def peek(conn, agent_id: Optional[int], channels: List[str], deep_mode: bool) -> Dict[str, Any]:
    trace_in()
    channel_queries = []
    params = []
...
def peek(args: List[str] = None) -> bool:
    ...
    try:
        ...
        result = peek(agent_id=agent_id, channels=channels, deep_mode=deep_mode)
