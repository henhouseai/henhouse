...
class TrainingMessaging:
    ...
    @db_write
    def queue_training_message(self, conn, agent_id: int, doc_path: str, question: str, gate_number: int, badge_ts: str) -> bool:
        trace_in()
        ...
        message_id = c_query(conn, "INSERT INTO watercooler_messages (from_agent_id, to_agent_id, kind, content, meta) VALUES (%s, %s, %s, %s, %s)", (None, agent_id, 'message', content, None))
        ...
        queue_id = c_query(conn, "INSERT INTO watercooler_queue_dm (agent_id, message_id, queued_ts) VALUES (%s, %s, NOW(6))", (agent_id, message_id))
        if queue_id is None:
    ...
    @db_write
    def queue_completion_message(self, conn, agent_id: int, message_type: str, badge_ts: str, role: str = None) -> bool:
        trace_in()
    ...
    @db_write
    def queue_promotion_message(self, conn, agent_id: int, new_role: str, badge_ts: str) -> bool:
        trace_in()
